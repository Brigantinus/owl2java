...
public class JavaWriter {
	...
	private static final String TEMPLATE_CLASS = TEMPLATE_ROOT + "class.vm";
	private static final String TEMPLATE_FACTORY = TEMPLATE_ROOT + "factory.vm";
	private static final String TEMPLATE_INTERFACE = TEMPLATE_ROOT + "interface.vm";
	private static final String TEMPLATE_TEST = TEMPLATE_ROOT + "test.vm";
	private static final String TEMPLATE_VOCABULARY = TEMPLATE_ROOT + "vocabulary.vm";
